...
describe('Ticket Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Project query and add missing value', () => {
      ...
      const project: IProject = { id: 26561 };
      ticket.project = project;

      const projectCollection: IProject[] = [{ id: 10574 }];
    ...
    it('Should call User query and add missing value', () => {
      const ticket: ITicket = { id: 456 };
      const assignedTo: IUser = { id: 14878 };
      ticket.assignedTo = assignedTo;

      const userCollection: IUser[] = [{ id: 8781 }];
    ...
    it('Should call Label query and add missing value', () => {
      const ticket: ITicket = { id: 456 };
      const labels: ILabel[] = [{ id: 5728 }];
      ticket.labels = labels;

      const labelCollection: ILabel[] = [{ id: 21413 }];
    ...
    it('Should update editForm', () => {
      const ticket: ITicket = { id: 456 };
      const project: IProject = { id: 27195 };
      ticket.project = project;
      const assignedTo: IUser = { id: 8416 };
      ticket.assignedTo = assignedTo;
      const label: ILabel = { id: 11121 };
      ticket.labels = [label];
