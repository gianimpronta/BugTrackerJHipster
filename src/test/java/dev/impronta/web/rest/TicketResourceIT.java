...
import dev.impronta.domain.Ticket;
import dev.impronta.repository.TicketRepository;
...
class TicketResourceIT {
    ...
    private static final String DEFAULT_DESCRIPTITON = "AAAAAAAAAA";
    private static final String UPDATED_DESCRIPTITON = "BBBBBBBBBB";
    ...
    public static Ticket createEntity(EntityManager em) {
        Ticket ticket = new Ticket().title(DEFAULT_TITLE).descriptiton(DEFAULT_DESCRIPTITON).dueDate(DEFAULT_DUE_DATE).done(DEFAULT_DONE);
        return ticket;
    }
    ...
    public static Ticket createUpdatedEntity(EntityManager em) {
        Ticket ticket = new Ticket().title(UPDATED_TITLE).descriptiton(UPDATED_DESCRIPTITON).dueDate(UPDATED_DUE_DATE).done(UPDATED_DONE);
        return ticket;
    }
    ...
    void createTicket() throws Exception {
        ...
        assertThat(testTicket.getDescriptiton()).isEqualTo(DEFAULT_DESCRIPTITON);
    ...
    void getAllTickets() throws Exception {
        ...
        restTicketMockMvc
            ...
            .andExpect(jsonPath("$.[*].descriptiton").value(hasItem(DEFAULT_DESCRIPTITON)))
    ...
    void getTicket() throws Exception {
        ...
        restTicketMockMvc
            ...
            .andExpect(jsonPath("$.descriptiton").value(DEFAULT_DESCRIPTITON))
    ...
    void putExistingTicket() throws Exception {
        ...
        updatedTicket.title(UPDATED_TITLE).descriptiton(UPDATED_DESCRIPTITON).dueDate(UPDATED_DUE_DATE).done(UPDATED_DONE);
        ...
        assertThat(testTicket.getDescriptiton()).isEqualTo(UPDATED_DESCRIPTITON);
    ...
    void partialUpdateTicketWithPatch() throws Exception {
        ...
        partialUpdatedTicket.title(UPDATED_TITLE).done(UPDATED_DONE);
    ...
    void fullUpdateTicketWithPatch() throws Exception {
        ...
        partialUpdatedTicket.title(UPDATED_TITLE).descriptiton(UPDATED_DESCRIPTITON).dueDate(UPDATED_DUE_DATE).done(UPDATED_DONE);
